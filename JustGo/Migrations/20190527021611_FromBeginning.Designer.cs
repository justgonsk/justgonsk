...
namespace JustGo.Migrations
{
    ...
    [Migration("20190527021611_FromBeginning")]
    partial class FromBeginning
    {
            ...
            modelBuilder.Entity("JustGoModels.Models.Event", b =>
                {
                    ...
                    b.Property<string>("JustGoUserId");
            ...
            modelBuilder.Entity("JustGoModels.Models.Event", b =>
                {
                    b.HasOne("JustGoModels.Models.Auth.JustGoUser")
                        .WithMany("AddedEvents")
                        .HasForeignKey("JustGoUserId");
